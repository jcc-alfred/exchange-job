const config = {
    ...
    report_emails:['jie.xiao@gtdollar.com',"dadi.xing@gtdollar.com","paul@gtdollar.com","xie.chao@gtdollar.com"],
    ...
    DB: {
        master:{
            host: 'trade.cmslmoq30ezu.ap-southeast-1.rds.amazonaws.com',
            user: 'gtdollar',
    ...
    redis:{
        host:'exchange.x8resv.0001.apse1.cache.amazonaws.com',
        port:'6379',
        db:0,
        prefix:'c_'
    },
